...
# Hướng dẫn fix lỗi password khi ssh
docker compose exec sshadmin bash
# đặt mật khẩu root
...
service ssh restart
# Copy cấu hình Apache từ WordPress ra host
docker cp secrulemap-huy-wordpress-1:/etc/apache2 ./container-apache2
